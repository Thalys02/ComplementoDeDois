...
public class Janela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Complemento de Dois");

        selecao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Converter p/ Decimal", "Converter p/ Binário" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(entrada, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
                    .addComponent(saida, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void converterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_converterActionPerformed
        ...
        if(selecao.getSelectedIndex()==0){
            BinarioDecimal();
        }else if(selecao.getSelectedIndex()==1){
            DecimalBinario();
        }else{
    }
    ...
    public void BinarioDecimal(){
        int N,A,Somatoria=0,res=0;
        String x = entrada.getText();
        int convert;
        
        N= x.length();
        
        convert= Character.getNumericValue((x.charAt(0)));
        
        A= -((int)(Math.pow(2, N-1))*convert);
        
        for(int i=1;i<N;i++){
           //Somatoria= (int)Math.pow(2,N-i-1);
           convert= Character.getNumericValue((x.charAt(i)));
           Somatoria=(int)Math.pow(2,N-i-1);
           Somatoria=Somatoria*convert;
           if(Somatoria!=1){
               res=res+Somatoria;
           } 
             ...
             res=res+A;           
            saida.setText(Integer.toString(res));
    }
    ...
    public void DecimalBinario(){
        ...
        int valor = Integer.parseInt(x);
         ...
         N= aux.length();
        convert= Character.getNumericValue((aux.charAt(0)));
        
        A= -((int)(Math.pow(2, N-1))*convert);
        
        for(int i=1;i<N;i++){
           //Somatoria= (int)Math.pow(2,N-i-1);
           convert= Character.getNumericValue((aux.charAt(i)));
           Somatoria=(int)Math.pow(2,N-i-1);
           Somatoria=Somatoria*convert;
           if(Somatoria!=1){
               res=res+Somatoria;
    ...
    /*
        para usar para o proximo exemplo é necessario colocar ex: 10- ? qual comprimento ?
    1-0
    2-4
    3-8
    4-16  ok
    seria 4 bits porem tem que incluir mais 1 para sinal => 5 bits :. 
    */
    /**
